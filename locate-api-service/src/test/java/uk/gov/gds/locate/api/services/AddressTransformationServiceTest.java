...
public class AddressTransformationServiceTest {
    ...
    public void shouldConvertAddressesToVCardFormat() {
        ...
        Address aOne = new Address("gssCode-1", "uprn-1", "postcode-1", "country-1", new Date(), pOne, detailsOne, location(1.1, 2.2), o1, "iv");
        ...
        assertThat(transformed.get(0).getVcard()).isEqualTo("ADR;:;;property-1;street-1;town-1;area-1;postcode-1;country-1");
        ...
        assertThat(transformed.get(1).getVcard()).isEqualTo("ADR;:;;property-2;street-2;town-2;area-2;postcode-2;country-2");
        ...
        assertThat(transformed.get(2).getVcard()).isEqualTo("ADR;:;;property-3;street-3;town-3;area-3;postcode-3;country-3");
    ...
    public void shouldConvertAddressToVCardSettingFieldsToNullIfNotPresent() {
        ...
        Address address = new Address("gssCode-1", "uprn-1", "postcode-1", "", new Date(), p, d, location(1.1, 2.2), new OrderingBuilder().build(), "iv");
